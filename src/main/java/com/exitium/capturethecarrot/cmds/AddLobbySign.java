...
import com.exitium.capturethecarrot.LobbySign;
...
public class AddLobbySign extends GameCommand{
	...
	public void onCommand(Player p, String[] args) {
		...
		SettingsManager.getSigns().set(String.valueOf(SettingsManager.getArenas().getKeys().size()), new LobbySign(target.getLocation(), arena));
